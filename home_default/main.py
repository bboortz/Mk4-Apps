...
# Title
ugfx.set_default_font(ugfx.FONT_TITLE)
ugfx.Label(0, ugfx.height() + info_height, ugfx.width(), info_height, "TiLDA Mk4", justification=ugfx.Label.CENTER)
# info
ugfx.Label(0, ugfx.height() + info_height * 2, ugfx.width(), info_height, "EMF 2018", justification=ugfx.Label.CENTER)
